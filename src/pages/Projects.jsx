        ...
        <Row>
          ...
          <Col sm={12} className="d-flex justify-content-center">
            <TableProjects
              ...
              modal={"Ubicada en el Distrito “Carachi Pampa”, Departamento de Antofagasta de la Sierra, provincia de Catamarca, Republica Argentina, aproximadamente a 40 Km. de la Localidad de Antofagasta de la Sierra y a 500 metros de la ruta provincial Nº43 la cual se encuentra pavimentada. Tiene una superficie mayor a las 3.000 Has.Con áreas aledañas confirmadas por la presencia de importantes empresas internacionales, Mina Beatriz se encuentra hoy en plena etapa de Inversión para la confirmación de recursos y obtención de la NI.43.101. Mina Beatriz se encuentra ubicada en la zona central de la cuenca del llamado Salar Escondido y sus condiciones para la explotación son óptimas. Existe información pública de los resultados sobre la etapa de exploración realizada por las empresas que trabajaron en la zona con excelentes perspectivas para la explotación."}
            />
          </Col>
          <Col sm={12} className="d-flex justify-content-center">
            <TableProjects
